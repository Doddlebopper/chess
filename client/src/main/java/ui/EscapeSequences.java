...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_ORANGE = SET_TEXT_COLOR + "202m";
    ...
    public static final String[] WHITE_PIECES = {WHITE_KING, WHITE_QUEEN, WHITE_BISHOP, WHITE_KNIGHT, WHITE_ROOK, WHITE_PAWN};
    public static final String[] BLACK_PIECES = {BLACK_KING, BLACK_QUEEN, BLACK_BISHOP, BLACK_KNIGHT, BLACK_ROOK, BLACK_PAWN};
}
